...
index 1baba7881286a1decc63a480f187c44bdb6f19ef..9df25e3ffaa8e72a5c2b11a49ce86925005a765e 100644
--- a/ai.js
+++ b/ai.js
@@ -1,106 +1,119 @@
 /**
...
+    const modelId = deviceCache === 'webgpu' && modelPreference === 'larger' ? MODELS.larger : MODELS.standard;
 ...
 /**
@@ -119,26 +132,26 @@ export async function answerQuestion(question, contactsContext) {
